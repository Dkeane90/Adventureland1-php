<section>
    ...
    <!-- Footer container -->
    <footer class="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left mt-36">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <p class="mb-4">
                        <a href="../views/family.view.php">Family Affair</a>
                    </p>
                    <p class="mb-4">
                        <a href="../views/kiddies.view.php">Kiddies Place</a>
                    </p>
                ...
                <div>
                    ...
                    <p class="mb-4">
                        <a href="../views/cart.view.php">Pricing</a>
                    </p>
                    <p class="mb-4">
                        <a href="../views/cart.view.php">Place Order</a>
                    </p>
                    <p>
                        <a href="../views/faq.view.php">FAQ's</a>
                    </p>
                </div>
                <!-- Contact section -->
                <div>
        ...
        <div class="bg-black/5 p-6 text-center">
            <span>&copy; 2024: AdventureLand</span>
